        ...
        <CardHeader className="text-center space-y-3 pt-6 pb-2 px-6">
          <CardTitle className="flex items-center justify-center gap-3">
            <img
              ...
              draggable={false}
            />
            <span className="text-4xl font-bold bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent tracking-wide leading-tight">
              Asaan Zindagi
            </span>
          </CardTitle>
        </CardHeader>
                  ...
                  {roles.map((role) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group flex flex-col items-center gap-2.5 p-4 rounded-xl border-2 transition-all duration-300 ${selectedRole === role.value
                      ...
                      >
                        <div className={`p-2.5 rounded-full bg-gradient-to-br ${role.color} shadow-md transition-transform duration-300 ${selectedRole === role.value ? 'scale-110' : 'group-hover:scale-105'
                          }`}>
