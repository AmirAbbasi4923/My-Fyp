        ...
        <CardHeader className="text-center space-y-3 pt-6 pb-2 px-6">
          <CardTitle className="flex items-center justify-center gap-2 sm:gap-3">
            <img
              ...
              draggable={false}
            />
            <span className="text-xl sm:text-2xl md:text-4xl font-semibold bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent tracking-tight">
              Reset Password
            </span>
          </CardTitle>
        </CardHeader>
